...
from promptkit.errors import InputValidationError, TemplateError
...
class MockEngine(BaseEngine):
    ...
    def _complete(self, messages: list[Message], **options: Any) -> Completion:
        return Completion(text=self.response, model=self.model, usage=Usage(1, 1))
...
class TestPrompt:
    ...
    def test_prompt_creation(self) -> None:
        ...
        assert prompt.joined_template == "Hello {{ name }}!"
...
class TestSchema:
    ...
    def test_create_schema_model(self) -> None:
        ...
        assert instance.model_dump() == {"name": "Alice", "age": 30}
...
class TestLoader:
    ...
    def test_save_and_load_prompt(self) -> None:
        ...
        try:
            ...
            assert loaded_prompt.joined_template == original_prompt.joined_template
    ...
    def test_load_without_extension(self) -> None:
        ...
        try:
            ...
            assert prompt_with_ext.joined_template == prompt_without_ext.joined_template
...
class TestRunner:
    ...
    def test_run_prompt_success(self) -> None:
        ...
        assert str(result) == "Generated response"
